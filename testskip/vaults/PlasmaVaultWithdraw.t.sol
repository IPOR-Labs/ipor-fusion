...
import {PlasmaVaultMarkets} from "../../contracts/vaults/PlasmaVaultMarkets.sol";
import {PlasmaVaultFees} from "../../contracts/vaults/PlasmaVaultFees.sol";
interface AavePool {
    ...
    function testShouldInstantlyWithdrawRequiredExitFromOneMarketAaveV3() public {
        ...
        PlasmaVault plasmaVault = new PlasmaVault(
            PlasmaVaultInitData(
                ...
                address(new PlasmaVaultMarkets()),
                address(new PlasmaVaultFees()),
                type(uint256).max,
                withdrawManager
            )
        );
