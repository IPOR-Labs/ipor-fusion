...
| 4   | **Katalog integracji.** `catalog/fuses.json` ma jeden wpis (ERC4626). Kolejne po jednej na zadanie, od używanych w produkcji, standard: `observed` na bloku, ABI wdrożonego fuse'a vs źródło.                                                                                       | done (2026-09-09)         | 66 wpisów, 48 katalogów, statusy i porządki: [INTEGRATIONS-TODO.md](INTEGRATIONS-TODO.md) |
