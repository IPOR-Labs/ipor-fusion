...
zespołu). **Pierwszy krok przed startem: potwierdzić kolejność listą produkcyjnych vaultów
i ich fuse'ów z MCP (`vaults_list`, `vault_info`)** i przepisać kolumnę Prio.
...
| 4   | `compound_v3`                         | 2 `COMPOUND_V3_USDC`, 13 `COMPOUND_V3_USDT`, 26 `COMPOUND_V3_WETH`                                   | 2    | 1   | –      | 7    | 0     | P1   | todo                     | jeden fuse, trzy market ID per comet                                        |
...
| 19  | `curve_stableswap_ng`                 | 16 `CURVE_POOL`                                                                                      | 2    | 1   | –      | 2    | 0     | P2   | todo                     |                                                                             |
...
| 36  | `universal_token_swapper`             | 12 `UNIVERSAL_TOKEN_SWAPPER` (+ `_V2`, ten sam ID)                                                   | 8    | 0   | –      | 10   | 0     | P2   | todo                     | swapper, brak balance fuse'a; dwie stałe o tej samej wartości               |
...
| R2  | `compound`             | 2    | 4                          | `test/fuses/compound_v3/CompoundV3ClaimFuseTest.t.sol`                                                                 | todo   |
...
- `UNIVERSAL_TOKEN_SWAPPER` i `UNIVERSAL_TOKEN_SWAPPER_V2` mają ten sam market ID 12.
...
Status w tej tabeli (`todo` → `done <hash>`) w tym samym commicie.
