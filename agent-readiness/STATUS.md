...
| T02 | Przykład konfiguracji RPC | P0 | T01 | ready-for-commit | 2026-09-08 | `.env.example` zawiera pięć pustych URL-i RPC; README opisuje wymaganie archive state i bezpieczne użycie `.env` |
