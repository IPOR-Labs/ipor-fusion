...
abstract contract WrappedPlasmaVaultBase is ERC4626Upgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 internal immutable _SHARE_SCALE_MULTIPLIER; /// @dev 10^_decimalsOffset() multiplier for share scaling in ERC4626

    uint256 internal constant FEE_PERCENTAGE_DECIMALS_MULTIPLIER = 1e4; /// @dev 10000 = 100% (2 decimal places for fee percentage)
     ...
     */
    function configureManagementFee(address feeAccount_, uint256 feeInPercentage_) external virtual;
     ...
     * @custom:security Restricted to contract owner
     */
    function configurePerformanceFee(address feeAccount_, uint256 feeInPercentage_) external virtual;
