...
contract AaveV3BalanceConnector is IConnectorBalance {
    ...
    function balanceOf(
        ...
        ) = IAaveProtocolDataProvider(AAVE_PROTOCOL_DATA_PROVIDER).getUserReserveData(asset, address(this));
        ...
        return (assetBalance * int256(PriceAdapter(PRICE_ADAPTER).getPrice(underlyingAsset, asset))) / 1e18;
    }
