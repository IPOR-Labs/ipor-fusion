...
uint16 constant FUSE_METADATA_AUDIT_STATUS_UNAUDITED_NAME = "Unaudited";
uint16 constant FUSE_METADATA_AUDIT_STATUS_REVIEWED_NAME = "Reviewed";
uint16 constant FUSE_METADATA_AUDIT_STATUS_TESTED_NAME = "Tested";
uint16 constant FUSE_METADATA_AUDIT_STATUS_AUDITED_NAME = "Audited";
...
uint16 constant FUSE_METADATA_CATEGORY_INFO_DEPOSIT_NAME = "Deposit";
uint16 constant FUSE_METADATA_CATEGORY_INFO_BALANCE_NAME = "Balance";
uint16 constant FUSE_METADATA_CATEGORY_INFO_DEX_NAME = "DEX";
uint16 constant FUSE_METADATA_CATEGORY_INFO_PERPETUAL_NAME = "Perpetual";
uint16 constant FUSE_METADATA_CATEGORY_INFO_BORROW_NAME = "Borrow";
uint16 constant FUSE_METADATA_CATEGORY_INFO_REWARDS_NAME = "Rewards";
...
uint16 constant FUSE_METADATA_ABI_VERSION_V1_NAME = "V1";
uint16 constant FUSE_METADATA_ABI_VERSION_V2_NAME = "V2";
...
uint16 constant FUSE_METADATA_PROTOCOL_INFO_AAVE_NAME = "Aave";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_COMPOUND_NAME = "Compound";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_CURVE_NAME = "Curve";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_EULER_NAME = "Euler";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_FLUID_NAME = "Fluid";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_GEARBOX_NAME = "Gearbox";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_HARVEST_NAME = "Harvest";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_MOONWELL_NAME = "Moonwell";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_MORPHO_NAME = "Morpho";
uint16 constant FUSE_METADATA_PROTOCOL_INFO_RAMSES_NAME = "Ramses";
