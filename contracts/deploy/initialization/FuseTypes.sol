...
library FuseTypes {
    ...
    string public constant CURVE_CHILD_LIQUIDITY_GAUGE_ERC4626_BALANCE_FUSE_NAME =
        "CURVE_CHILD_LIQUIDITY_GAUGE_ERC4626_BALANCE_FUSE";

    uint16 public constant CURVE_STABLESWAP_NG_SINGLE_SIDE_BALANCE_FUSE_ID = 17;
    string public constant CURVE_STABLESWAP_NG_SINGLE_SIDE_BALANCE_FUSE_NAME =
        "CURVE_STABLESWAP_NG_SINGLE_SIDE_BALANCE_FUSE";

    uint16 public constant CURVE_STABLESWAP_NG_SINGLE_SIDE_SUPPLY_FUSE_ID = 18;
    string public constant CURVE_STABLESWAP_NG_SINGLE_SIDE_SUPPLY_FUSE_NAME =
        "CURVE_STABLESWAP_NG_SINGLE_SIDE_SUPPLY_FUSE";
    ...
    string public constant UNIVERSAL_TOKEN_SWAPPER_WITH_VERIFICATION_FUSE_NAME =
        "UNIVERSAL_TOKEN_SWAPPER_WITH_VERIFICATION_FUSE";
