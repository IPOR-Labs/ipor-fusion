...
enum VelodromSuperchainSlipstreamSubstrateType {
    UNDEFINED,
    Gauge,
    Pool
}

struct VelodromSuperchainSlipstreamSubstrate {
    VelodromSuperchainSlipstreamSubstrateType substrateType;
    address substrateAddress;
}

library VelodromSuperchainSlipstreamSubstrateLib {
    function substrateToBytes32(
        VelodromSuperchainSlipstreamSubstrate memory substrate
    ...
    ) internal pure returns (VelodromSuperchainSlipstreamSubstrate memory substrate) {
        substrate.substrateType = VelodromSuperchainSlipstreamSubstrateType(uint256(bytes32Substrate) >> 160);
