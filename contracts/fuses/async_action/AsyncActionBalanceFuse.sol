...
///      The balance is converted to USD using the price oracle middleware and IporMath utilities.
/// @author IPOR Labs
contract AsyncActionBalanceFuse is IMarketBalanceFuse {
    ...
    /// @notice Initializes the balance fuse with the market identifier
    ...
    ///      and converts to USD using IporMath.convertToWad.
    ///      Returns 0 if executor doesn't exist or balance is zero.
    ///      Requires price oracle middleware to be configured in the Plasma Vault.
    ///      The underlying asset is determined by calling asset() on the ERC4626 vault interface.
