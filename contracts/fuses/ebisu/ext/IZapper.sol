...
interface IZapper {
    ...
    function collToken() external view returns (address); // added here but the remote ABI has it

    function boldToken() external view returns (address); // added here but the remote ABI has it

    function troveManager() external view returns (address); // added here but the remote ABI has it
}
