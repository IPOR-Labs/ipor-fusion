...
/// @title SiloV2SupplyNonBorrowableCollateralFuse
/// @notice Fuse for supplying non-borrowable collateral to Silo V2 protocol
/// @author IPOR Labs
contract SiloV2SupplyNonBorrowableCollateralFuse is SiloV2SupplyCollateralFuseAbstract {
    ...
    /// @return collateralType The collateral type used
    ...
    /// @return siloAssetAmount The amount of silo assets supplied
    function enter(
    ...
    {
        return _enter(ISilo.CollateralType.Protected, data_);
    }
    ...
    /// @return siloAssetAmount The amount of silo assets received
    function exit(
    ...
    {
        return _exit(ISilo.CollateralType.Protected, data_);
    }
