...
/**
 * @dev Ethereum Mainnet LiquidityGaugeV6 interface
 * @dev Key difference vs IChildLiquidityGauge: withdraw(uint256, bool) instead of withdraw(uint256, address, bool)
 */
