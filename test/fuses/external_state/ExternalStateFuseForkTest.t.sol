...
///         family against a forked mainnet, real USDC, and the shared ExternalState fork fixture.
contract ExternalStateFuseForkTest is ExternalStateForkTestBase {
    ...
    function test_fork_enter_action_exit_happy() public {
        ...
        // Build an action invoking the ExternalState target's `deposit(address,uint256)` selector. The
    ...
    function test_fork_balanceFuseReturnsUsdWad_consistentWithOracle() public {
        _setPrice(USDC, 1.01e18); // $1.01 (18-decimal feed)
