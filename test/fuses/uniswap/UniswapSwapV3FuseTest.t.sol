...
contract UniswapSwapV3FuseTest is Test {
    ...
    function _getFuses() private returns (address[] memory fuses_) {
        UniswapSwapV3Fuse uniswapSwapV3Fuse = new UniswapSwapV3Fuse(
            IporFusionMarketsArbitrum.UNISWAP_SWAP_V3,
            _UNIVERSAL_ROUTER
        );
    ...
    function _setupMarketConfigs() private returns (MarketSubstratesConfig[] memory marketConfigs_) {
        ...
        marketConfigs_[0] = MarketSubstratesConfig(IporFusionMarketsArbitrum.UNISWAP_SWAP_V3, uniswapTokens);
    }
    //
    function _setupFuses() private returns (address[] memory fuses_) {
        _uniswapSwapV3Fuse = new UniswapSwapV3Fuse(IporFusionMarketsArbitrum.UNISWAP_SWAP_V3, _UNIVERSAL_ROUTER);
    ...
    function _setupBalanceFuses() private returns (MarketBalanceFuseConfig[] memory balanceFuses_) {
        UniswapBalanceFuse uniswapBalance = new UniswapBalanceFuse(IporFusionMarketsArbitrum.UNISWAP_SWAP_V3);

        balanceFuses_ = new MarketBalanceFuseConfig[](1);
        balanceFuses_[0] = MarketBalanceFuseConfig(IporFusionMarketsArbitrum.UNISWAP_SWAP_V3, address(uniswapBalance));
    }
}
