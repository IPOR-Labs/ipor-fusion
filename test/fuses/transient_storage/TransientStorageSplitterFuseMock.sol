...
import {TransientStorageSplitterFuse, TransientStorageSplitterFuseEnterData} from "../../../contracts/fuses/transient_storage/TransientStorageSplitterFuse.sol";
import {TransientStorageLib} from "../../../contracts/transient_storage/TransientStorageLib.sol";

/// @title TransientStorageSplitterFuseMock
/// @notice Mock contract for executing fuse via delegatecall
/// @author IPOR Labs
contract TransientStorageSplitterFuseMock {
    ...
    function enter(TransientStorageSplitterFuseEnterData calldata data_) external {
        address(fuse).functionDelegateCall(
            abi.encodeWithSelector(TransientStorageSplitterFuse.enter.selector, data_)
        );
    }
