...
/// @title MidasPendingRequestsStorageLibHarness
/// @notice Test harness that exposes MidasPendingRequestsStorageLib internal functions as external calls.
///         Since all library functions are internal, this harness is required for unit testing.
///         The harness inherits the ERC-7201 storage slot via delegatecall context.
contract MidasPendingRequestsStorageLibHarness {
    // ============ Deposit Wrappers ============
