...
/// @title ExternalStateExecutorTest
/// @notice 66 unit tests for ExternalStateExecutor targeting 100% branch coverage.
contract ExternalStateExecutorTest is Test {
    MockPlasmaVaultForExternalState internal vault;
    ExternalStateExecutor internal executor;

    MockERC20ForExternalState internal asset6; // 6 decimals
    MockERC20ForExternalState internal asset18; // 18 decimals
    ...
    function test_constructor_revertsOnZeroMarketId() public {
        vm.expectRevert(abi.encodeWithSelector(ExternalStateErrors.ExternalStateExecutorZeroMarketId.selector));
        new ExternalStateExecutor(0, address(vault));
    }
    ...
    function test_setSubstrates_revertsWhenCallerNotVault() public {
        bytes32[] memory subs = new bytes32[](2);
        subs[0] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(100);
        subs[1] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(200);
        vm.expectRevert(abi.encodeWithSelector(ExternalStateErrors.ExternalStateExecutorUnauthorizedVault.selector));
        executor.setSubstrates(subs);
    }

    function test_setSubstrates_fromVault_revertsOnMissingMandatorySingleton() public {
        // BIG_CHANGE_BPS present, STALENESS_MAX missing — the push path must apply the same
        // mandatory-singleton validation as syncSubstrates.
    ...
    function test_setSubstrates_fromVault_populatesCachesLikeSync() public {
        bytes32[] memory subs = new bytes32[](5);
        subs[0] = ExternalStateSubstrateLib.encodeCustodianSubstrate(custodianA);
        subs[1] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount1);
        subs[2] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset6));
        subs[3] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(4321);
        subs[4] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(777);
        ...
        assertEq(executor.assets(0), address(asset6));
        assertEq(executor.stalenessMax(), 4321);
        assertEq(executor.bigChangeBps(), 777);
    ...
    function test_syncSubstrates_clearsStaleCacheEntries() public {
        ...
        subs[0] = ExternalStateSubstrateLib.encodeCustodianSubstrate(custodianA);
        subs[1] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset6));
        subs[2] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(100);
        subs[3] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(200);
    ...
    function test_syncSubstrates_revertsOnDuplicateStalenessMax() public {
        bytes32[] memory subs = new bytes32[](2);
        subs[0] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(1);
        subs[1] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(2);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        vm.expectRevert(
    ...
    function test_syncSubstrates_revertsOnDuplicateBigChangeBps() public {
        bytes32[] memory subs = new bytes32[](2);
        subs[0] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(100);
        subs[1] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(200);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        vm.expectRevert(
            abi.encodeWithSelector(
    ...
    function test_syncSubstrates_revertsOnDuplicateDustThreshold() public {
        bytes32[] memory subs = new bytes32[](2);
        subs[0] = ExternalStateSubstrateLib.encodeDustThresholdSubstrate(10);
        subs[1] = ExternalStateSubstrateLib.encodeDustThresholdSubstrate(20);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        vm.expectRevert(
            abi.encodeWithSelector(
    ...
    function test_syncSubstrates_revertsOnDuplicateMinUpdateInterval() public {
        bytes32[] memory subs = new bytes32[](2);
        subs[0] = ExternalStateSubstrateLib.encodeMinUpdateIntervalSubstrate(60);
        subs[1] = ExternalStateSubstrateLib.encodeMinUpdateIntervalSubstrate(120);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        vm.expectRevert(
            abi.encodeWithSelector(
    ...
    function test_syncSubstrates_ignoresUndefinedTypes() public {
        ...
        bytes32 targetSub = ExternalStateSubstrateLib.encodeTargetSubstrate(address(target), bytes4(0x12345678));
        bytes32 stalenessSub = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(42);
        bytes32 bigChangeSub = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(500);
    ...
    function test_syncSubstrates_emitsBalanceAccountPurged() public {
        ...
        emit ExternalStateExecutor.BalanceAccountPurged(balanceAccount1);
        vm.expectEmit(true, false, false, true, address(executor));
        emit ExternalStateExecutor.BalanceAccountPurged(balanceAccount2);
        executor.syncSubstrates();
    }
    ...
    function test_syncSubstrates_revertsOnDuplicateBAInSubstrates() public {
        ...
        subs[0] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount1);
        subs[1] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount1);
        subs[2] = ExternalStateSubstrateLib.encodeCustodianSubstrate(custodianA);
        subs[3] = ExternalStateSubstrateLib.encodeCustodianSubstrate(custodianB);
        subs[4] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        subs[5] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(BIG_CHANGE_BPS_DEFAULT);
        vault.grantMarketSubstrates(MARKET_ID, subs);
    ...
    function test_syncSubstrates_initialSyncIsNoOpForPurge() public {
        ...
        ExternalStateExecutor freshExecutor = new ExternalStateExecutor(MARKET_ID, address(vault));
    ...
    function test_proposeBalance_revertsWhenBalanceAccountNotGranted() public {
        ...
        bytes32 expectedEncoded = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(notGrantedBA);
    ...
    function test_proposeBalance_revertsAfterBalanceAccountRevoked() public {
        ...
        bytes32 expectedEncoded = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount1);
    ...
    function test_proposeBalance_revertsWhenBalanceAccountInVaultButNotInCache() public {
        ...
        vm.prank(custodianA);
        vm.expectRevert(
            abi.encodeWithSelector(ExternalStateErrors.ExternalStateExecutorBalanceAccountNotInCache.selector, newBA)
        );
    ...
    function test_addBalance_emitsBalanceChangedByFuse() public {
        vm.prank(address(vault));
        vm.expectEmit(true, false, false, true, address(executor));
        emit ExternalStateExecutor.BalanceChangedByFuse(balanceAccount1, int256(500), 500);
        executor.addBalance(balanceAccount1, 500);
    }
    ...
    function test_removeBalance_emitsBalanceChangedByFuse() public {
        ...
        vm.prank(address(vault));
        vm.expectEmit(true, false, false, true, address(executor));
        emit ExternalStateExecutor.BalanceChangedByFuse(balanceAccount1, -int256(300), 700);
    ...
    function test_addBalance_acceptsInt256MaxBoundary() public {
        ...
        vm.prank(address(vault));
        vm.expectEmit(true, false, false, true, address(executor));
        emit ExternalStateExecutor.BalanceChangedByFuse(balanceAccount1, type(int256).max, maxAllowed);
    ...
    function test_removeBalance_revertsOnInt256Overflow() public {
        ...
        // Re-seed so removeBalance won't trip ExternalStateExitExceedsTrackedBalance first. We push one
    ...
    function test_removeBalance_reentrancyProtection() public {
        ...
        actions[0] = ExternalStateExecutorAction({target: address(target), data: outerCall});
    ...
    function test_execute_revertsWhenNotVault() public {
        ExternalStateExecutorAction[] memory actions = new ExternalStateExecutorAction[](0);
        vm.expectRevert(abi.encodeWithSelector(ExternalStateErrors.ExternalStateExecutorUnauthorizedVault.selector));
        executor.execute(actions);
    }
    ...
    function test_execute_reentrancyProtection() public {
        ...
        ExternalStateExecutorAction[] memory innerActions = new ExternalStateExecutorAction[](0);
        bytes memory innerCall = abi.encodeCall(IExternalStateExecutor.execute, (innerActions));
        bytes memory outerCall = abi.encodeCall(MockExternalStateTarget.reenter, (address(executor), innerCall));
    ...
    function test_withdrawAssetBalance_worksForAssetNotInSubstrates() public {
        MockERC20ForExternalState unknown = new MockERC20ForExternalState("Unknown", "UNK", 18);
    ...
    function test_withdrawAssetBalance_emitsAssetWithdrawn() public {
        ...
        vm.prank(address(vault));
        vm.expectEmit(true, false, false, true, address(executor));
        emit ExternalStateExecutor.AssetWithdrawn(address(asset6), 1e6);
        executor.withdrawAssetBalance(address(asset6));
    }
    ...
    function test_proposeBalance_dustCheck_unsyncedNewAsset_skipped() public {
        ...
        MockERC20ForExternalState newAsset = new MockERC20ForExternalState("New", "NEW", 8);
        ...
        subs[2] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount1);
        subs[3] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount2);
        subs[4] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset6));
        subs[5] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset18));
        subs[6] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(newAsset));
        subs[7] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        subs[8] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(BIG_CHANGE_BPS_DEFAULT);
        subs[9] = ExternalStateSubstrateLib.encodeDustThresholdSubstrate(100);
        vault.grantMarketSubstrates(MARKET_ID, subs);
    ...
    function test_confirmBalance_emitsBalanceConfirmed() public {
        ...
        vm.prank(custodianB);
        vm.expectEmit(true, true, false, true, address(executor));
        emit ExternalStateExecutor.BalanceConfirmed(balanceAccount1, custodianB, 0, 100, n);
        executor.confirmBalance(balanceAccount1, h);
    }
    ...
    function test_getBalanceFuseSnapshot_returnsZeroWhenNoAccounts() public {
        ...
        bytes32[] memory subs = new bytes32[](2);
        subs[0] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(500);
        subs[1] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        executor.syncSubstrates();
    ...
    function test_getOldestUpdateTimestamp_returnsZeroWhenNoAccounts() public {
        bytes32[] memory subs = new bytes32[](2);
        subs[0] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        subs[1] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(BIG_CHANGE_BPS_DEFAULT);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        executor.syncSubstrates();
        assertEq(executor.getOldestUpdateTimestamp(), 0);
    }
    ...
    ///      the mutant reverts with `ExternalStateExecutorProposalExpired`.
    ...
    ///      the mutant reverts with `ExternalStateExecutorMinUpdateIntervalNotMet`.
    ...
    function test_proposeBalance_reentrancyGuarded() public {
        ...
        bytes32[] memory subs = new bytes32[](6);
        subs[0] = ExternalStateSubstrateLib.encodeCustodianSubstrate(address(reentrant));
        subs[1] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount1);
        subs[2] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(reentrant));
        subs[3] = ExternalStateSubstrateLib.encodeDustThresholdSubstrate(100);
        subs[4] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        subs[5] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(BIG_CHANGE_BPS_DEFAULT);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        executor.syncSubstrates();
        ...
        reentrant.setTarget(
            address(executor),
            abi.encodeWithSelector(IExternalStateExecutor.proposeBalance.selector, balanceAccount1, uint256(999))
        );
    ...
    function test_confirmBalance_reentrancyGuarded() public {
        ...
        subs[0] = ExternalStateSubstrateLib.encodeCustodianSubstrate(custodianA);
        subs[1] = ExternalStateSubstrateLib.encodeCustodianSubstrate(address(reentrant));
        subs[2] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(balanceAccount1);
        subs[3] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(reentrant));
        subs[4] = ExternalStateSubstrateLib.encodeDustThresholdSubstrate(100);
        subs[5] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        subs[6] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(BIG_CHANGE_BPS_DEFAULT);
        vault.grantMarketSubstrates(MARKET_ID, subs);
        executor.syncSubstrates();
    ...
    ///      to `ExternalStateSubstrateType.UNDEFINED`, which `decodeSubstrateType` allows (only raw > 8 reverts).
    ...
    function test_syncSubstrates_silentlyIgnoresUndefinedSubstrate() public {
        ...
        bytes32 stalenessSub = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(77);
        bytes32 bigChangeSub = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(500);
    ...
    function _grantDefaultSubstrates(uint256 dust_) internal {
        ...
        subs[4] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset6));
        subs[5] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset18));
        subs[6] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        subs[7] = ExternalStateSubstrateLib.encodeMinUpdateIntervalSubstrate(MIN_UPDATE_INTERVAL_S);

        bytes32[] memory all = new bytes32[](10);
        for (uint256 i; i < 8; i++) {
            all[i] = subs[i];
        }
        all[8] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(BIG_CHANGE_BPS_DEFAULT);
        all[9] = ExternalStateSubstrateLib.encodeDustThresholdSubstrate(dust_);
    ...
    function _grantSubstratesWithBAs(address[] memory bas_) internal {
        ...
        all[0] = ExternalStateSubstrateLib.encodeCustodianSubstrate(custodianA);
        all[1] = ExternalStateSubstrateLib.encodeCustodianSubstrate(custodianB);
        all[2] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset6));
        all[3] = ExternalStateSubstrateLib.encodeAssetSubstrate(address(asset18));
        all[4] = ExternalStateSubstrateLib.encodeStalenessMaxSubstrate(STALENESS_MAX_S);
        all[5] = ExternalStateSubstrateLib.encodeMinUpdateIntervalSubstrate(MIN_UPDATE_INTERVAL_S);
        all[6] = ExternalStateSubstrateLib.encodeBigChangeBpsSubstrate(BIG_CHANGE_BPS_DEFAULT);
        all[7] = ExternalStateSubstrateLib.encodeDustThresholdSubstrate(DUST_THRESHOLD_DEFAULT);
        for (uint256 i; i < baCount; ++i) {
            all[8 + i] = ExternalStateSubstrateLib.encodeBalanceAccountSubstrate(bas_[i]);
        }
        vault.grantMarketSubstrates(MARKET_ID, all);
    }
