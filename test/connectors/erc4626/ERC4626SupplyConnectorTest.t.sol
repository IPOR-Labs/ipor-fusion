...
contract ERC4626SupplyConnectorTest is Test {
    ...
    function testShouldBeAbleToSupplyWethToMetaMorpho() external {
        ...
        Erc4626SupplyConnector connector = new Erc4626SupplyConnector(1);
        VaultERC4626Mock vaultMock = new VaultERC4626Mock(address(connector));
        ...
        vaultMock.enter(Erc4626SupplyConnector.Erc4626SupplyConnectorData({vault: marketAddress, amount: amount}));
    ...
    function testShouldBeAbleToWithdrawWethFromMetaMorpho() external {
        ...
        vaultMock.exit(Erc4626SupplyConnector.Erc4626SupplyConnectorData({vault: marketAddress, amount: amount / 2}));
